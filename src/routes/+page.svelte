...
<div class="bg-gray text-white">
    <div class="container mx-auto h-screen font-mono p-4">
        ...
        {#if !data.twitchBot?.authenticated}
            <div class="my-2">
                <a
                    class="p-2 bg-purple text-white"
                    href={data.twitchBot?.authUrl}
                >
...
"
        ...
        <label class="relative inline-flex items-center cursor-pointer">
            ...
            />
            <div
                class="w-11 h-6 bg-gray border border-purple peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-pink dark:peer-focus:ring-pink rounded-full peer dark:bg-gray peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-purple
            peer-disabled:opacity-50 peer-disabled:cursor-not-allowed
            "
            />
            <span
